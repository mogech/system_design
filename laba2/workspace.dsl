workspace {
    model {
        ...
        socialNetwork = softwareSystem "Социальная сеть" {
            ...
            database = container "База данных" "In-memory" 
        ...
        userService -> database "Читает/записывает пользователей" "In-memory"
        wallService -> database "Читает/записывает записи" "In-memory"
    }
